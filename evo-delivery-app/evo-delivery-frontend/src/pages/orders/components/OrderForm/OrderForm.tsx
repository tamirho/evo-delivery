  ...
  return (
    <Stack component='form' onSubmit={handleSubmit(onSubmit)} spacing={3} style={{ width: '100%', margin: 20 }}>
      ...
      <TextField
        ...
        helperText={
          errors.address && errors.address.type === 'validAddress' ? 'Address not found' : 'Address is required'
        }
      />
      <TextField
        id='filled-number'
      ...
      {state !== ENTITY_VIEW_STATES.view ? (
        ...
        <Button type='submit' variant='contained' color='info' style={{ borderRadius: 50 }} startIcon={<EditIcon />}>
          Edit
        </Button>
      )}
    </Stack>
